          ...
          <StaggerItem key={index}>
            <div className="group flex flex-col items-center bg-background dark:bg-background/50 rounded-2xl border border-border p-6 shadow-sm hover:shadow-lg transition-all duration-300 h-full">
              ...
              <div className="flex flex-col items-center text-center flex-1">
                ...
                {member.description && (
                  <p className="text-muted-foreground text-sm mt-3 leading-relaxed line-clamp-4 max-w-xs">
                    {member.description}
                  </p>
                )}
                {member.linkedin_url && (
                  <a
                    ...
                    className="mt-4 flex items-center justify-center w-9 h-9 rounded-full bg-[#0A66C2]/10 text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-colors duration-200"
                  >
