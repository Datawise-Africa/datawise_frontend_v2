...
import type { Route } from './+types/tools.sheria-ai';
...
export function meta(_args: Route.MetaArgs) {
  return [
    ...generateSEOTags({
      title: 'Sheria AI - Legal Assistant',
      description:
        'Sheria AI is your smart legal companion for searching Kenyan laws, getting case insights, and understanding legal information with ease.',
      url: href('/tools/sheria-ai'),
      keywords:
...
export default function ToolsSheriaAi() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const { data } = await gptApi.post('/gpt/sheria-ai/', {
        ...
        <div className="bg-white mt-12 shadow px-4 py-6">
          <div className="text-center">
            <h1 className="text-xl sm:text-2xl font-bold text-[#1e293b]">
              SHERIA AI - Your Legal Assistant
            </h1>
            <p className="text-gray-600 text-sm max-w-2xl mx-auto leading-snug">
              Your smart legal companion for searching Kenyan laws, getting case
              insights, and understanding legal information with ease
            </p>
          </div>
        </div>
