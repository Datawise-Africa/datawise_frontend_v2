...
export function meta(_args: Route.MetaArgs) {
  return [
    ...generateSEOTags({
      ...
      description:
        "Datawise Africa is an R&D company solving Africa's challenges through data and AI — building trusted data systems and fostering local research leadership.",
      url: href('/'),
      keywords:
