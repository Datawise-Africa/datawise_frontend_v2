 ...
 * @returns {JSX.Element} The custom toast component.
 */
function CustomToast({ t, type, title, message }) {
  ...
  return (
    <div
      ...
      } max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 transform transition-all duration-300`}
    >
      ...
      <div className="flex border-l border-gray-200">
        <button
          ...
          className="w-full border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
